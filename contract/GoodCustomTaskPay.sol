...
/**
 * @title GoodCustomTaskPay
 * @notice G$ escrow for custom on-chain bounty tasks on Celo.
 ...
 */
contract GoodCustomTaskPay is Ownable, ReentrancyGuard, EIP712 {
    ...
    constructor(
        address _signer,
        address _gdollar
    ) Ownable(msg.sender) EIP712("GoodCustomTaskPay", "1") {
